<?php
	...
	if( $preciominimo>0 ){
		$idProducto = crearSubasta($_SESSION['id_usuario'], $titulo, $descripcion, $preciominimo, $fechafin);
	}else{
		//if($idProducto = crearSubastaCDirecta($_SESSION['id_usuario'], $titulo, $descripcion, $preciominimo, $compradirecta, $fechafin));
	}
