<?php
	require_once('../php/internasUsuario.php');
	session_start();

	$titulo = $_POST['titulo'];
	$descripcion = $_POST['descripcion'];
	$preciominimo = $_POST['preciominimo'];
	$compradirecta = $_POST['compradirecta'];
	...
	if( $compradirecta=="" ){
		crearSubasta($_SESSION['id_usuario'], $titulo, $descripcion, $preciominimo, $fechafin);
	}else{
		crearSubastaCDirecta($_SESSION['id_usuario'], $titulo, $descripcion, $preciominimo, $compradirecta, $fechafin);
	}
...
$nuevo_nombre="../productos/".$_FILES['tmp_name'].$extension;


// Solo permitimos ficheros "normales" de tamaño
if($_FILES['archivo']['size']>10000 OR 
